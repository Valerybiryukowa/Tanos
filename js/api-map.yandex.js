(function ymapsInit(e) {
                ...
                allPatiently: function(e) {
                    return _.allResolved(e).then(function() {
                        ...
                        for (; u < a;)
                            r = s[u++],
                            o = e[r],
                            _.isRejected(o) ? (n || (n = i ? [] : {}), i ? n.push(o.valueOf()) : n[r] = o.valueOf()) : n || ((t || (t = i ? [] : {}))[r] = _.valueOf(o));
                        if (n)
                            throw n;
                        return t
                    })
    ...
    t.utils = function(e) {
        ...
        return r.nextTick = o.__nextTick__, o.__nextTick__ = void 0, r.isArray = Array.isArray ? Array.isArray : function(e) {
            ...
            for (var o = 0; o < n.length; o++)
                if (t[o].__expand)
                    r.registerImports(e, t[o].__expand.depends, t[o].__expand.imports);
                else {
    ...
    function() {
        ...
        function n() {
            ...
            try {
                ...
                t || (t = r.getContext(n = "experimental-webgl", o), t || (n = null))
            } catch (i) {
                n = null
            }
            return n ? {
    ...
    t.modules = new o({
        ...
        fetchBundle: function(e) {
            ...
            o.setAttribute("data-ymaps-api-version", "2.1.79-12635949"),
            o.async = !0;
            var i = t.vow.defer();
    ...
    t.env.server.params.csp && !t.supports.csp.isSupported && t.logger.warning("CSP is not supported in this browser"),
    ...
    "enterprise": false,
    "bundles": {
        "full": "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-12635949/build/release/full-6eb2efd4f22f8a8aaecad0004cf1547a5683967d.js"
    },
    "version": "2.1.79",
    "tag": "2.1.79-12635949",
    ...
    "token": "567e5fe4d85c46b8781163f13d543e8c",
    ...
    "hosts": {
        ...
        "taxiRouteInfo": "https://taxi-routeinfo.taxi.yandex.net/taxi_info?clid=yamaps&apikey=WlLCOrBcRkvgvXHWKlKzRPFPOGoDuhxeTUqIslT&rll={rll}"
    },
    "layers": {
        "map": {
            "version": "23.11.01-1-b231030182430",
            "scaled": true,
        ...
        "sta": {
            "version": "2023.11.02.01.51-2_23.11.03-0-17056"
        },
        "stv": {
            "version": "2023.11.02.01.51-2_23.11.03-0-17056"
        },
